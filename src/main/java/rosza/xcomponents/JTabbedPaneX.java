...
public class JTabbedPaneX  extends BasicTabbedPaneUI {
  ...
  protected void installDefaults() {
    ...
    super.darkShadow = Constant.TEXT_COLOR;
    super.shadow = Constant.CELL_BORDER_COLOR;
    super.lightHighlight = Constant.CELL_BORDER_COLOR;
    super.focus = Color.black;
    super.highlight = Color.GREEN;
    selectColor = Color.red;//Constant.BG_DARKER_BLUE;
    deSelectColor = Color.green;//Constant.CELL_BORDER_COLOR;
  ...
  protected void paintTabBackground(Graphics g, int tabPlacement, int tabIndex, int x, int y, int w, int h, boolean isSelected) {
    ...
    switch (tabPlacement) {
      ...
      default:
        ...
        gradientShadow = new GradientPaint(0, 0, Constant.BG_DARKER_BLUE, 0, y + h / 2, Constant.BG_BLUE);
        break;
    }
    ...
    if(isSelected) {
      ...
      if(tabPane.isEnabled() && tabPane.isEnabledAt(tabIndex)) {
        ...
        GradientPaint gradientShadowTmp = new GradientPaint(0, 0, Constant.BG_DARKER_COLOR, 0, y + h / 2, Constant.BG_COLOR);
        g2D.setPaint(gradientShadowTmp);
      }
      else {
        GradientPaint gradientShadowTmp = new GradientPaint(0, 0, Constant.BG_DARKER_COLOR, 0, y + 15 + h / 2, Constant.BG_COLOR);
        g2D.setPaint(gradientShadowTmp);
      }
    }
    g2D.fill(shape);
  ...
  protected void paintFocusIndicator(Graphics g, int tabPlacement, Rectangle[] rects, int tabIndex, Rectangle iconRect, Rectangle textRect, boolean isSelected) {
    if(tabPane.hasFocus() && isSelected) {
      g.setColor(Constant.BG_DARKER_COLOR);
      g.drawPolygon(shape);
    }
  }
